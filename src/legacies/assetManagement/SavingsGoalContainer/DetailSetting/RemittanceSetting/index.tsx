    ...
    <RoundedPaper my={1}>
      <Stack direction="row" justifyContent="space-between">
        ...
        <SwitchButton
          ...
          handleChange={() =>
            handleRemittance({ ...remittance, isOn: !remittance.isOn })
          }
        />
      </Stack>
        ...
        <Stack spacing={1} mt={1}>
          ...
          <FormControl fullWidth>
            <OutlinedInput
              id="bankName"
              startAdornment={
                <InputAdornment position="start">은행명</InputAdornment>
              }
          ...
          <FormControl fullWidth>
            <OutlinedInput
              id="accountNumber"
              startAdornment={
                <InputAdornment position="start">계좌번호</InputAdornment>
              }
          ...
          <FormControl fullWidth size="small">
            <Select
              ...
              startAdornment={
                <InputAdornment position="start">송금일</InputAdornment>
              }
              endAdornment={
              ...
              onChange={(e) =>
                changeRemittance({
                  target: { id: "date", value: e.target.value },
                })
              }
            >
              {options.map((option) => (
          ...
          <FormControl fullWidth>
            <OutlinedInput
              id="amount"
              startAdornment={
                <InputAdornment position="start">송금액</InputAdornment>
              }
      ...
      <ModalStaticBackdrop
        ...
        component={
          <InputModal
            ...
            closeTransferDateModal={closeTransferDateModal}
          />
        }
      />
    </RoundedPaper>
