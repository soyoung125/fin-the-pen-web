    ...
    <>
      <Stack direction="row" justifyContent="space-between">
        <Stack justifyContent="space-between">
          ...
          <Box
            sx={{
              color: "var(--gray-scale-040, #8C919C)",
              fontSize: "15px",
            }}
          >
            {moment().locale("ko").format("YYYY M D a hh:mm")}
          </Box>
        </Stack>
      ...
      <List
        sx={{
          padding: 0,
          borderTop: "1px solid var(--gray-scale-005, #F7F7F8)",
        }}
      >
        <ListItem
        ...
        >
          <ListItemIcon
            sx={{
              ...
              marginRight: "8px",
              borderRadius: "8px",
              background: "var(--gray-scale-020, #C8CBD0)",
            }}
          >
            <AddRoundedIcon sx={{ fontSize: 16 }} />
          </ListItemIcon>
          <ListItemText primary="추가 또는 삭제" />
        </ListItem>
      </List>
